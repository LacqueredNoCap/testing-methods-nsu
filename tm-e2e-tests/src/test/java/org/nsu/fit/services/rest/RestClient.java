...
public class RestClient {
    ...
    public TopUpBalanceResponse toUpBalance(TopUpBalancePojo topUpBalancePojo, AccountTokenPojo accountToken) {
        return post("/customers/top_up_balance", JsonMapper.toJson(topUpBalancePojo, true), TopUpBalanceResponse.class, accountToken);
    }
